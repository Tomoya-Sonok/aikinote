...
|---|---|---|---|
| `favorite` | 投稿にいいね | 投稿者 | "[username] があなたの投稿にいいねしました" |
| `favorite_reply` | 返信にいいね | 返信者 | "[username] があなたの返信にいいねしました" |
...
| アクション | ルート | プッシュ送信関数 |
|---|---|---|
| 投稿いいね | `social-favorites/index.ts` | `sendPushToUser()` |
| 返信いいね | `social-favorites/index.ts` | `sendPushToUser()` |
...
- プッシュ送信失敗が本体処理（通知レコード作成、いいね/返信の処理）を止めることはない
