...
const mockSocialPosts: SocialPost[] = [
	{
		...
		title: "四方投げのコツについて",
		content: "四方投げを練習していて、相手のバランスを崩すタイミングが分からず困っています。どなたかアドバイスをいただけませんか？",
		tags: ["四方投げ", "質問", "初心者"],
	...
	},
	{
		...
		authorAvatar: "/images/default-avatar.svg",
		title: "昨日の稽古で学んだこと",
		content: "入身投げの際の足捌きについて、先生から指導を受けました。相手の正面から入るのではなく、斜めに入身することで、より自然に技が決まることを学びました。",
		tags: ["入身投げ", "足捌き", "気づき"],
	...
	},
	{
		...
		authorAvatar: "/images/default-avatar.svg",
		title: "審査に向けての練習",
		content: "来月の昇級審査に向けて、基本技の復習をしています。特に正面打ち一教の精度を上げたいと思っています。",
		tags: ["審査", "一教", "正面打ち"],
