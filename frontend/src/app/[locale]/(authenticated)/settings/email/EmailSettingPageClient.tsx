...
import styles from "./EmailSettingPageClient.module.css";

interface EmailSettingPageClientProps {
	locale: string;
}
...
export function EmailSettingPageClient({
	locale,
}: EmailSettingPageClientProps) {
