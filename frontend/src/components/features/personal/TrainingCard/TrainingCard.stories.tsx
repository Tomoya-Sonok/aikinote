...
const meta: Meta<typeof TrainingCard> = {
  title: "Features/Personal/TrainingCard",
...
export const Default: Story = {
  args: {
    ...
    title: "サンプルトレーニング",
    content:
      "これはトレーニングカードのサンプルコンテンツです。長いテキストの場合の表示を確認できます。",
    date: "2024-01-15",
...
export const LongContent: Story = {
  args: {
    ...
    title: "長いコンテンツのサンプル",
    content:
      "これは非常に長いコンテンツのサンプルです。複数行にわたるテキストがどのように表示されるかを確認するためのものです。改行やレイアウトが適切に処理されることを確認できます。",
    date: "2024-01-13",
