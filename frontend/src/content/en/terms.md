...
These Terms shall apply to all relationships between users and the operator of the Service ("Operator") regarding the use of the Service.

## Article 2 (Registration)

1. Registration is completed when a prospective user agrees to these Terms, applies for registration in the manner prescribed by the Operator, and the Operator approves the application.
2. The Operator may decline a registration application if it determines that the applicant:
   - Has provided false information in the registration application
   - Has previously violated these Terms
   - Is otherwise deemed inappropriate for registration by the Operator

## Article 3 (User ID and Password Management)

1. Users shall manage their user ID and password for the Service under their own responsibility.
2. Users may not transfer, lend, or share their user ID and password with any third party under any circumstances.
3. When a login is performed with a user ID and password combination that matches the registered information, it shall be deemed to be used by the user who registered that user ID.
...
3. Activities that destroy or interfere with the server or network functions of the Operator, other users, or other third parties
4. Activities that may interfere with the operation of the Service
5. Activities that collect or accumulate personal information of other users
...
1. The Operator may suspend or interrupt all or part of the Service without prior notice to users if it determines that any of the following reasons exist:
...
2. The Operator shall not be liable for any disadvantage or damage suffered by users or third parties due to the suspension or interruption of the Service.
...
1. The Operator may restrict all or part of a user's use of the Service or delete a user's registration without prior notice if the user:
   - Violates any provision of these Terms
   - Is found to have false information in registered matters
   - Is otherwise deemed inappropriate for use of the Service by the Operator
